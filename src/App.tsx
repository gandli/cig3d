  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 z-10 text-[#3c342a] text-[10px] md:text-xs tracking-[0.12em] opacity-50 hover:opacity-80 transition-opacity px-3 py-1.5 rounded-full border border-[#3c342a]/20 bg-white/30 backdrop-blur-sm"
        aria-label="重置视角"
      >
        重置
      </button>
      ...
      {/* 底部提示 */}
      <div className="absolute bottom-4 md:bottom-6 left-1/2 -translate-x-1/2 text-[#3c342a] text-[10px] md:text-xs tracking-[0.12em] md:tracking-[0.16em] opacity-45 pointer-events-none lowercase whitespace-nowrap">
